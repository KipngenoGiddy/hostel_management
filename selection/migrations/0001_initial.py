    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('student', 'Student'), ('warden', 'Warden'), ('guest', 'Guest')], default='student', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='selection.Room')),
